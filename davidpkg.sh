...
printf "\n"
printf "\e[1;32mhi Hacker welcome to my tool for install all pkg in one click" 
...
D̶a̶v̶i̶d̶ H̶a̶t̶ D̶a̶v̶i̶d̶ H̶a̶t̶ D̶a̶v̶i̶d̶ H̶a̶t̶  D̶a̶v̶i̶d̶ H̶a̶t̶
█
██████╗░██╗░░██╗░██████╗░install all pkg 
██╔══██╗██║░██╔╝██╔════╝░
██████╔╝█████═╝░██║░░██╗░in one click 
...
subscribe my channel >>David Hat<<"
